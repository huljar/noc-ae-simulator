...
#ifndef __HAECCOMM_ENTRYGUARDSPLIT_H_
#define __HAECCOMM_ENTRYGUARDSPLIT_H_
...
/**
 * Module class that is used to manage the crypto modules in the interwoven authentication protocol
 */
class EntryGuardSplit : public cSimpleModule, public cListener {
public:
