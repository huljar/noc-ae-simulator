...
Define_Module(EncoderImplSplit);

EncoderImplSplit::EncoderImplSplit() {
}
...
void EncoderImplSplit::initialize() {
    NetworkCodingBase::initialize();
}

void EncoderImplSplit::handleMessage(cMessage* msg) {
