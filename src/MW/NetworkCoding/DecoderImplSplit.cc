...
Define_Module(DecoderImplSplit);

DecoderImplSplit::DecoderImplSplit() {
}
...
void DecoderImplSplit::initialize() {
    NetworkCodingBase::initialize();
}

void DecoderImplSplit::handleMessage(cMessage* msg) {
